...
namespace Caen1725
{
  ...
  public:
    RootEventVec(bool handle_traces = false)
    {
      ...
      caen_time      = new std::vector<ULong64_t>;
    ...
    void push_back(RootHit const & hit)
    {
      ...
      caen_time     -> push_back(hit.caen_time    );
    ...
    void writeTo(TTree* tree)
    {
      ...
      tree->Branch("caen_time"    , &caen_time    );
    ...
    std::vector<ULong64_t>  * caen_time     = nullptr;
